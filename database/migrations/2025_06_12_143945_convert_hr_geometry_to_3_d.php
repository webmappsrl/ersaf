...
return new class extends Migration
{
    ...
    public function up(): void
    {
        DB::transaction(function () {
            ...
            DB::statement('UPDATE ec_tracks SET geometry_temp = ST_Force3D(geometry::geometry)::geography WHERE geometry IS NOT NULL');
    ...
    public function down(): void
    {
        DB::transaction(function () {
            ...
            DB::statement('UPDATE ec_tracks SET geometry_temp = ST_Force2D(geometry::geometry)::geography WHERE geometry IS NOT NULL');
