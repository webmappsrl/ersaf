...
class OsmServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        Artisan::call('wm-osmfeatures:initialize-tables', ['--table' => 'ec_tracks']);
        if (! Schema::hasColumn('ec_tracks', 'geometry')) {
    ...
    /** @test */
    public function ec_track_exists_returns_true_if_relation_id_is_valid()
    {
    ...
    /** @test */
    public function get_ec_track_works_as_expected()
    {
    ...
    /** @test */
    public function get_ec_track_returns_false_if_relation_id_is_not_valid()
    {
    ...
    /** @test */
    public function get_ec_track_geojson_works_as_expected()
    {
    ...
    /** @test */
    public function get_ec_track_geojson_returns_false_if_relation_id_is_not_valid()
    {
    ...
    /** @test */
    public function get_ec_track_gpx_works_as_expected()
    {
    ...
    /** @test */
    public function get_ec_track_geometry_works_as_expected()
    {
    ...
    /** @test */
    public function get_ec_track_geometry_returns_false_if_relation_id_is_not_valid()
    {
    ...
    /** @test */
    public function get_ec_track_geometry3857_works_as_expected()
    {
    ...
    /** @test */
    public function get_ec_track_geometry3857_returns_false_if_relation_id_is_not_valid_or_empty()
    {
    ...
    /** @test */
    public function get_ec_track_gpx_returns_false_if_relation_id_is_not_valid()
    {
    ...
    /** @test */
    public function update_ec_track_model_with_osm_data_works_as_expected()
    {
    ...
    {
        $this->assertDatabaseHas('ec_tracks', [
            'id' => $hikingRoute->id,
