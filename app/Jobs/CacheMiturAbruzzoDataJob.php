...
class CacheMiturAbruzzoDataJob implements ShouldQueue
{
    ...
    protected function buildHikingRouteGeojson($hikingRoute): array
    {
        ...
        $huts = $hikingRoute->getElementsInBuffer(new CaiHut, config('osm2cai.ec_track_buffer'));
        $caiHuts = [];
    ...
    protected function buildMountainGroupGeojson($mountainGroup): array
    {
        ...
        $properties['ec_tracks_map'] = route('mountain-groups-hr-map', ['id' => $mountainGroup->id]);
        $properties['images'] = [];
        $properties['activity'] = 'Escursionismo';
        ...
        $properties['ec_tracks'] = $mountainGroup->hikingRoutes->where('osm2cai_status', 4)->pluck('updated_at', 'id')->toArray();
    ...
    protected function buildEcPoiGeojson($poi): array
    {
        ...
        $properties['activity'] = 'Escursionismo';
        $properties['has_ec_tracks'] = $hikingRoutesInBuffer->pluck('updated_at', 'id')->toArray() ?? [];
    ...
    protected function buildCaiHutGeojson($hut): array
    {
        ...
        $properties['ec_tracks'] = $hikingRoutes->count() > 0 ? $hikingRoutes->pluck('updated_at', 'id')->toArray() : [];
