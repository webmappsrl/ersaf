...
class MiturAbruzzoController extends Controller
{
     ...
     * ),
     * example={"type":"Feature","properties":{"id":1,"name":"Mountain Group Name","sections":{1},"area":"123","region":"Lazio","provinces":"Roma","municipalities":"Roma","map":"url_mappa","description":"Description of the mountain group","aggregated_data":"aggregated data","protected_area":"Parchi Aree protette Natura 2000","activity":"Escursionismo, Alpinismo", "ec_tracks": { "2806": "2024-02-24T03:48:14.000000Z" },"ec_pois":{1},"cai_huts":{1},"map":"mappa gruppo montuoso","ec_tracks_map":"mappa percorsi","disclaimer":"testo disclaimer","ec_pois_count":1,"cai_huts_count":1, "images":{"http://example.com/image.jpg"}},"geometry":{"type":"MultiPolygon","coordinates":{{{10.4495294,43.7615252},{10.4495998,43.7615566}}}}}
     * )
     * ),
     *
     * @OA\Response(
    ...
    */
    ...
    public static function mountainGroupsHrMap($id)
    {
        ...
        $hikingRoutesIntersectingIds = Cache::remember('ec_tracks_intersecting_' . $id, 60 * 24, function () use ($mountainGroup) {
        ...
        $hikingRoutesGeojson = array_map(function ($hikingRoute) {
            $routeGeom = DB::select('SELECT ST_AsGeoJSON(geometry) as geom FROM ec_tracks WHERE id = ?', [$hikingRoute]);
