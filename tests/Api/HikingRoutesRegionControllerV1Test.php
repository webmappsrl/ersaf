...
class HikingRoutesRegionControllerV1Test extends TestCase
{
    ...
    public function test_ec_track_list_by_region()
    {
    ...
    public function test_ec_track_list_by_region_not_found()
    {
    ...
    public function test_ec_track_list_by_region_no_routes()
    {
        $region = $this->createTestRegion('L');
    ...
    public function test_ec_track_osm_list_by_region()
    {
        // Prepara i dati di test
        $region = $this->createTestRegion('L');
        $hikingRoute = $this->createTestHikingRoute(1, 12345, 4);
    ...
    public function test_ec_track_by_id()
    {
        // Prepara i dati di test
        $hikingRoute = $this->createTestHikingRoute(1, 12345, 4);
    ...
    public function test_ec_track_by_id_not_found()
    {
        DB::table('ec_tracks')->truncate();
    ...
    public function test_ec_track_by_osm_id()
    {
        // Prepara i dati di test
        $hikingRoute = $this->createTestHikingRoute(1, 12345, 4);
    ...
    public function test_ec_track_by_osm_id_not_found()
    {
    ...
    public function test_ec_track_list_by_bounding_box()
    {
        // Prepara i dati di test
        $hikingRoute = $this->createTestHikingRoute(1, 12345, 4);
    ...
    public function test_ec_track_osm_list_by_bounding_box()
    {
        // Prepara i dati di test
        $hikingRoute = $this->createTestHikingRoute(1, 12345, 4);
    ...
    public function test_ec_track_collection_too_large_bounding_box()
    {
