...
class MigrationCheck extends Controller
{
    const preparedQueries = [
        ...
        // HIKING ROUTES
        'count hiking routes' => [
            'legacy' => 'SELECT COUNT(*) as num from ec_tracks;',
            'current' => 'SELECT COUNT(*) as num from ec_tracks;',
        ],
        'count hiking routes with osm2cai_status=1' => [
            'legacy' => 'SELECT COUNT(*) as num from ec_tracks WHERE osm2cai_status=1;',
            'current' => 'SELECT COUNT(*) as num from ec_tracks WHERE osm2cai_status=1;',
        ],
        'count hiking routes with osm2cai_status=2' => [
            'legacy' => 'SELECT COUNT(*) as num from ec_tracks WHERE osm2cai_status=2;',
            'current' => 'SELECT COUNT(*) as num from ec_tracks WHERE osm2cai_status=2;',
        ],
        'count hiking routes with osm2cai_status=3' => [
            'legacy' => 'SELECT COUNT(*) as num from ec_tracks WHERE osm2cai_status=3;',
            'current' => 'SELECT COUNT(*) as num from ec_tracks WHERE osm2cai_status=3;',
        ],
        'count hiking routes with osm2cai_status=4 / 1' => [
            'legacy' => 'SELECT COUNT(*) as num from ec_tracks WHERE osm2cai_status=4;',
            'current' => 'SELECT COUNT(*) as num from ec_tracks WHERE osm2cai_status=4;',
        ],
        'count hiking routes with osm2cai_status=4 / 2' => [
            'legacy' => 'SELECT COUNT(*) as num from ec_tracks WHERE validation_date IS NOT NULL;',
            'current' => 'SELECT COUNT(*) as num from ec_tracks WHERE validation_date IS NOT NULL;',
        ],
        'count hiking routes with osm2cai_status=4 / 3' => [
            'legacy' => 'SELECT COUNT(*) as num from ec_tracks WHERE user_id IS NOT NULL;',
            'current' => 'SELECT COUNT(*) as num from ec_tracks WHERE validator_id IS NOT NULL;',
        ],

        // HIKING ROUTES ISSUE STATUS
        'count hiking routes with issues_status=precorribile' => [
            'legacy' => "SELECT COUNT(*) as num from ec_tracks WHERE issues_status='percorribile';",
            'current' => "SELECT COUNT(*) as num from ec_tracks WHERE issues_status='percorribile';",
        ],
        'count hiking routes with issues_status=non percorribile' => [
            'legacy' => "SELECT COUNT(*) as num from ec_tracks WHERE issues_status='non percorribile';",
            'current' => "SELECT COUNT(*) as num from ec_tracks WHERE issues_status='non percorribile';",
        ],
        'count hiking routes with issues_status=percorribile parzialmente' => [
            'legacy' => "SELECT COUNT(*) as num from ec_tracks WHERE issues_status='percorribile parzialmente';",
            'current' => "SELECT COUNT(*) as num from ec_tracks WHERE issues_status='percorribile parzialmente';",
        ],
        'count hiking routes with issues_status=sconosciuto' => [
            'legacy' => "SELECT COUNT(*) as num from ec_tracks WHERE issues_status='sconosciuto';",
            'current' => "SELECT COUNT(*) as num from ec_tracks WHERE issues_status='sconosciuto';",
        ],
        'count hiking routes with issue_description' => [
            'legacy' => 'SELECT COUNT(*) as num from ec_tracks WHERE issues_description IS NOT NULL;',
            'current' => 'SELECT COUNT(*) as num from ec_tracks WHERE issues_description IS NOT NULL;',
        ],
        'count hiking routes with issues_last_update' => [
            'legacy' => 'SELECT COUNT(*) as num from ec_tracks WHERE issues_last_update IS NOT NULL;',
            'current' => 'SELECT COUNT(*) as num from ec_tracks WHERE issues_last_update IS NOT NULL;',
        ],
        'count hiking routes with issues_user_id' => [
            'legacy' => 'SELECT COUNT(*) as num from ec_tracks WHERE issues_user_id IS NOT NULL;',
            'current' => 'SELECT COUNT(*) as num from ec_tracks WHERE issues_user_id IS NOT NULL;',
        ],
        'count hiking routes with issues_chronology' => [
            'legacy' => 'SELECT COUNT(*) as num from ec_tracks WHERE issues_chronology IS NOT NULL;',
            'current' => 'SELECT COUNT(*) as num from ec_tracks WHERE issues_chronology IS NOT NULL;',
        ],

        // HIKING ROUTES FAVORITE:
        'count hiking routes with region favorite=true' => [
            'legacy' => 'SELECT COUNT(*) as num FROM ec_tracks WHERE region_favorite = true;',
            'current' => 'SELECT COUNT(*) as num FROM ec_tracks WHERE region_favorite = true;',
        ],
        'count hiking routes with description_cai_it not null' => [
            'legacy' => 'SELECT COUNT(*) as num FROM ec_tracks WHERE description_cai_it IS NOT NULL;',
            'current' => 'SELECT COUNT(*) as num FROM ec_tracks WHERE description_cai_it IS NOT NULL;',
        ],
        'count hiking routes with feature_image not null' => [
            'legacy' => 'SELECT COUNT(*) as num FROM ec_tracks WHERE feature_image IS NOT NULL;',
