...
class CheckNearbyHutsJobTest extends TestCase
{
    ...
    public function test_handles_ec_track_with_geometry(): void
    {
        ...
        $this->assertTrue(DB::table('ec_track_cai_hut')->where('ec_track_id', $hikingRoute->id)->exists());
    }

    public function test_handles_ec_track_with_geometry_and_finds_nearby_cai_hut(): void
    {
        $hikingRoute = HikingRoute::factory()->createQuietly([
            'id' => 999999999,
    ...
    public function test_no_nearby_cai_huts_found(): void
    {
        ...
        $this->assertFalse(DB::table('ec_track_cai_hut')->where('ec_track_id', $hikingRoute->id)->exists());
    }
