...
class HikingRouteControllerV2Test extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        if (! Schema::hasColumn('ec_tracks', 'osmfeatures_data')) {
    ...
    public function test_ec_track_index()
    {
    ...
    public function test_ec_track_index_by_region()
    {
        $region = $this->createTestRegion('L');
        $hikingRoute = $this->createTestHikingRoute(1, 12345, 4, $region->geometry);

        DB::table('ec_track_region')->insert([
            'ec_track_id' => $hikingRoute->id,
            'region_id' => $region->id,
        ]);
    ...
    public function test_ec_track_osm_index_by_region()
    {
        $region = $this->createTestRegion('L');
        $hikingRoute = $this->createTestHikingRoute(1, 12345, 4);
    ...
    public function test_ec_track_show()
    {
        $hikingRoute = $this->createTestHikingRoute(1, 12345, 4);
    ...
    public function test_ec_track_tdh()
    {
        $hikingRoute = $this->createTestHikingRoute(1, 12345, 4);
    ...
    public function test_ec_track_show_by_osm_id()
    {
        $hikingRoute = $this->createTestHikingRoute(1, 12345, 4);
    ...
    public function test_ec_track_index_by_bounding_box()
    {
        $hikingRoute = $this->createTestHikingRoute(1, 12345, 4);
    ...
    public function test_ec_track_osm_index_by_bounding_box()
    {
        $hikingRoute = $this->createTestHikingRoute(1, 12345, 4);
    ...
    public function test_ec_track_collection_by_bounding_box()
    {
        $hikingRoute = $this->createTestHikingRoute(1, 12345, 4);
    ...
    public function test_ec_track_show_returns_404_when_not_found()
    {
    ...
    public function test_ec_track_show_returns_404_when_no_geometry()
    {
        $hikingRoute = $this->createTestHikingRoute(1, 12345, 4);
    ...
    public function test_ec_track_show_by_osm_id_returns_404_when_not_found()
    {
    ...
    public function test_ec_track_show_by_osm_id_returns_404_when_no_geometry()
    {
        $hikingRoute = $this->createTestHikingRoute(1, 12345, 4);
        // Rimuovi la geometria
        DB::table('ec_tracks')
    ...
    public function test_ec_track_collection_by_bounding_box_returns_500_when_area_too_large()
    {
    ...
    public function test_ec_track_collection_by_bounding_box_returns_empty_collection_when_no_routes()
    {
    ...
    public function test_ec_track_tdh_returns_404_when_not_found()
    {
    ...
    public function test_ec_track_index_by_region_returns_404_when_no_routes()
    {
        $region = $this->createTestRegion('L');
    ...
    public function test_ec_track_osm_index_by_region_returns_empty_array_when_no_routes()
    {
        $region = $this->createTestRegion('L');
    ...
    public function test_ec_track_index_by_bounding_box_returns_empty_array_when_no_routes()
    {
    ...
    public function test_ec_track_osm_index_by_bounding_box_returns_empty_array_when_no_routes()
    {
    ...
    public function test_ec_track_show_handles_invalid_osmfeatures_data()
    {
        $hikingRoute = $this->createTestHikingRoute(1, 12345, 4);
    ...
    public function test_ec_track_show_by_osm_id_handles_invalid_osmfeatures_data()
    {
        $hikingRoute = $this->createTestHikingRoute(1, 12345, 4);
