...
class CheckNearbyCaiHuts extends Command
{
     ...
     * @var string
     */
    protected $signature = 'osm2cai:check-nearby-huts {ec_track_id}';
    ...
    public function handle()
    {
        ...
        $hikingRoute = HikingRoute::find($this->argument('ec_track_id'));

        if (! $hikingRoute) {
            Log::warning("Hiking route {$this->argument('ec_track_id')} not found");
